...
export default function ApplicationFormPage() {
  ...
  const applyToTrip = (event)=>{
    ...
    const body = form
    axios.post (
      `https://us-central1-labenu-apis.cloudfunctions.net/labeX/alessandra-marmiroli-silveira/trips/${tripId}/apply`, body
    ) .then((response) => {
      console.log(response.data);
      cleanFields()
      alert("Deu Certo!")
   ...
   return (
    <Div>
      ...
      <Form onSubmit={applyToTrip}>
        <Select onChange={onChangeSelect} value={tripId}>
